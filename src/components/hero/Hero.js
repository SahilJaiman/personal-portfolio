...
export default function Hero() {
    ...
    return (
        <div>
            ...
            <div className="flex flex-col h-screen md:flex-row-reverse transition-all duration-500 ease-in-out md:p-10 text-black dark:bg-[#131417] bg-white dark:text-white">

                <div
                    className="relative w-full h-screen flex flex-col  items-center justify-center space-y-10 "
                    data-aos="zoom-in-left"
                >
                    <div className="relative w-full h-full transition duration-500 ease-in-out hover:scale-105 ">
                ...
                <div
                    className="border-2  border-red-600 flex flex-col h-screen items-center justify-center space-y-14 px-10 pb-10"
